...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Task t1 = new Task(null, "Varrer Vassourinha", "Varrer inimigos de brasilia", Instant.now(),  e3, new TaskAuthorDTO(e3));
        Task t2 = new Task(null, "Fazer 50 anos em 5", "Desenvolver 50 anos de industria no Brasil em 5 anos.", Instant.now(),  e1, new TaskAuthorDTO(e1));
        Task t3 = new Task(null, "Botar o retrato do velho", "Colocar o retrato de Getúlio na estante, pois ele vai voltar.", Instant.now(),  e2, new TaskAuthorDTO(e2));
